...
<div class="page-banner">
  ...
  <div class="full-width-split group">
      ...
      <div class="full-width-split__inner">
        ...
        <?php 
          ...
          while($homepage_events->have_posts()) {
            ...
            // 1st arg points to what file
            // 2nd arg is optional, gets something in the slug  from the 1st arg
    ...
    <div class="full-width-split__two">
      <div class="full-width-split__inner">
        <h2 class="headline headline--small-plus t-center">From Our Blogssss</h2>
        <?php 
